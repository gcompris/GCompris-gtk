...
class HerziPropertiesGroup(gtk.VBox):
    def __init__(self, label):
        ...
        self.label_w.set_alignement(0.0, 0.5)
        self.pack_start(self.label_w, False, False, 0)

        self.alignement = gtk.Alignement(0.0, 0.5, 1.0, 1.0)
    ...
    def add(self, label, widget):
        ...
        label_w.set_alignement(0.0, 0.5)
        ...
        self.ntern.pack_start(box, False, False, 0)
