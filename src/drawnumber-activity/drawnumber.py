...
class Gcompris_drawnumber :
  ...
  def load_data(self,level): #Data of this game
    ...
    if level==1 : #Picture with 1 to 20 points
      ...
      data={}
      data[1]=[[28,"images/dn_epouvantail1.png", "images/dn_epouvantail2.png"],
      ...
      data[2]=[[37,"images/dn_plane1.png", "images/dn_plane2.png"],
      ...
      data[2]=[[71,"images/dn_bear1.png", "images/dn_bear2.png"],
      ...
      data[3]=[[85,"images/dn_hibou1.png", "images/dn_hibou2.png"],
